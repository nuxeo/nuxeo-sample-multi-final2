...
pipeline {
  ...
  environment {
    ...
    STUDIO_PROJECT_RELEASE_URL = 'https://connect.nuxeo.com/nuxeo/site/studio/v2/project/nuxeo-final2-test-projec/releases'
    ...
    ORG = 'nuxeo'
    DOCKER_IMAGE_NAME = "nuxeo-sample-final2"
  }
